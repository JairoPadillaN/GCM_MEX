...
{   
    ...
    public function filtrofolio(Request $request)
    {   
        $fechainicio = $request->fechainicio;
        ...
        or c.razonSocial LIKE '%$folio%' 
        or s.sucursal LIKE  '%$folio%')
        and fechafactura >= '$fechainicio' and fechafactura <= '$fechafinal'
        )AS t1
        ");
    ...
    {   $fechainicio = $request->fechaInicio;
        ...
        INNER JOIN clientes AS c ON c.idc = f.idc
        INNER JOIN sucursales AS s ON s.idSucursal = f.idSucursal
        where fechafactura >= '$fechainicio' and fechafactura <= '$fechafinal'and c.razonSocial like '%$cliente%'
        )AS t1
        ");
    ...
    public function filtrosucursal(Request $request)
    {
        ...
        INNER JOIN clientes AS c ON c.idc = f.idc
        INNER JOIN sucursales AS s ON s.idSucursal = f.idSucursal
        where s.sucursal like '%$sucursal%'
        )AS t1
        ");
