...
class cotizacionServiciosController extends Controller{
      ...
      if ($stipo == 'Administrador') {
        ...
        if ($idc == "todos") {
          $registros = DB::table('cotizacionServicios')
            ->select('idCotizacionServicios','numeroCotizacion','cotizacionServicios.created_at','fechaCotizacion','clonActual','noServicios','estatus','cotizacionServicios.nombreUsuario','repetidos','numCotizacion','clienteSucursal',
  ...
  public function actualizarCotizacionServicios(Request $request){
    ...
    $corrigiendoidCotizacionClon = \DB::UPDATE("UPDATE detalleCotizacionServicios 
  ...
  public function pdfCotizacionServicios(Request $request){
    ...
    $pdf = \PDF::loadView('cotizacionServiciosPDF',
