...
{{Form::open(['route' => 'editar_Sucursales','files'=>true])}}
{{Form::token()}}
...
$(document).ready(function() {
    ...
    $("#guardarCont").click(function(e) {  
        ...
        if(puesto == '' && nombreCont == ''){
            ...
            $("#reporteCont").load('{{url('contacto_Suc')}}' + '?' + $(this).closest('form').serialize());
        }
    });
...
<!-- 
                                    ...
                                    <center>
                                        ...
                                        <a href="{{asset('reporte_Sucursales')}}"><button type="button"
