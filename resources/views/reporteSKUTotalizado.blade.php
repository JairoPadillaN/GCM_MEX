                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('reporteTopVentas.filtro') }}" method="get">
                                    ...
                                    <input type="date" id="ini" name="ini" style="margin-left: 15px" required>

                                    <label for="fin" style="margin-left: 15px">Fecha Fin:  </label>
                                    <input type="date" id="fin" name="fin" style="margin-left: 15px" required>
