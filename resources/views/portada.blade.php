...
<body>
    ...
    <nav class="navbar navbar-default" role="navigation" style="background-color:#3576AB">
       ...
       otro elemento que se pueda ocultar al minimizar la barra -->
        <div class="collapse navbar-collapse navbar-ex1-collapse" style="font-size: 18px; padding-top: 15px;">
            <div style="text-align:left;">
                <ul class="nav navbar-nav">
                    <li><a href="{!! asset('login')!!}" class="btn btn-danger"
                            style="background-color:#3576AB; border-color:#3576AB; color:#FFFFFF; font-size: 20px; ">Ingresar</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container overlay">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
            <div class="site-heading" style="text-align: center;">
                <img src="archivos/logo1a.png" alt="Logo" style="max-width: 1100px; width: 100%; height: auto; margin: 20px auto 10px; display: block;">
            </div>
        </div>   
    </div>
