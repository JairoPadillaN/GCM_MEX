...
{{Form::open(['route' => 'guardarEditarCotizacion','files'=>true])}}
{{Form::token()}}
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                {{Form::hidden('idCotizacion',$cotizacionEditar->idCotizacion,['class' => 'form-control rounded-0', 'readonly'])}}
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class='' id="validarEstatus">
                            ...
                            <div class="row">
                                ...
                                @elseif($cotizacionEditar->estatus == "Facturada")
                                    <div class="form-group col-md-7">
                                        <div>{{Form::radio('estatus','En revisión')}} En revisión</div>
                                        <div>{{Form::radio('estatus','Pendiente de autorización')}} Pendiente de autorización
                                        </div>
