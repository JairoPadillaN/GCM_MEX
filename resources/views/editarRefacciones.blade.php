...
{{Form::open(['route' => 'editarRefacciones','files'=>true])}}
{{Form::token()}}

<div class="col-xs-12">
    <div class="panel panel-default" style="margin-top:-55px">
        <div class="panel-heading">
            <h1>Modificación de refacciones</h1>
        </div>
            ...
            <div class="">
                <div class="form-group col-md-6">
                    ...
                    <div>
                        ...
                        @endif
                        {{Form::text('nombreRefaccion',$consulta->nombreRefaccion,['class' => 'form-control', 'placeholder' => 'Ejemplo: Electrico'])}}
                    </div>
                    ...
                    <div>
                        ...
                        <select name='idTipoRefacciones' class="form-control">
                            <option value='{{$idTipoSel}}'>{{$nomref}}</option>
                            @foreach($ref as $tr)
                            @if($tr->activo=="Si")
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div>
                                ...
                                @endif
                                {{Form::text('numeroParte',$consulta->numeroParte,['class' => 'form-control', 'placeholder' => 'Ejemplo: E-1 ó 1652'])}}
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div>
                        ...
                        <select name='idProveedor' class="form-control">
                            <option value='{{$idProvSel}}'>{{$nomprov}}</option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div>
                        ...
                        Stock {{Form::radio('estatus','Stock', true, ['checked' => 'checked'])}}&nbsp;&nbsp;&nbsp;
                        Solicitado {{Form::radio('estatus','Solicitado',false, [])}}&nbsp;&nbsp;&nbsp;
                        Enviado a reparar {{Form::radio('estatus','Enviado a reparar',false, [])}}
                        @elseif($consulta->estatus == 'Solicitado')
                        Stock {{Form::radio('estatus','Stock',false, [])}}&nbsp;&nbsp;&nbsp;
                        Solicitado
                        {{Form::radio('estatus','Solicitado', true, ['checked' => 'checked'])}}&nbsp;&nbsp;&nbsp;
                        Enviado a reparar {{Form::radio('estatus','Enviado a reparar',false, [])}}
                        @else
                        Stock {{Form::radio('estatus','Stock',false, [])}}&nbsp;&nbsp;&nbsp;
                        Solicitado {{Form::radio('estatus','Solicitado',false, [])}}&nbsp;&nbsp;&nbsp;
                        Enviado a reparar {{Form::radio('estatus','Enviado a reparar', true, ['checked' => 'checked'])}}
                        @endif
                    </div>
<br>
                    ...
                    <div>
                        ...
                        @endif
                        {{Form::text('precioLista',$consulta->precioLista,['class' => 'form-control', 'placeholder' => 'Ejemplo: 405.00'])}}
                    </div>
                    ...
                    <div>
                        ...
                        @endif
                        {{Form::text('precioUltimo',$consulta->precioUltimo,['class' => 'form-control', 'placeholder' => 'Ejemplo: 405.00'])}}
                    </div>
                </div>
                <br>
                <center>
