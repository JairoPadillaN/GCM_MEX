            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1 class="">Alta de Rango Comisiones </h1> 
                    </div><br>

                    <div class="panel-body">
                        <form action="{{ route('storerango') }}" method="POST">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Rango Inicial</label>
                                    <input type="number" name="rangoInicial" class="form-control rangoinicial" id="inputEmail4"
                                        placeholder="Rango Inicial">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Rango Final</label>
                                    <input type="number" name="rangoFinal" class="form-control rangofinal" id="inputPassword4"
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <input name="porcentajeComision" value="0" step="1" type="number"
                    ...
                    <div>
                      <center><button type="submit" class="btn-lg btn-primary">Agregar Rango</button></center><br>
