...
<div id='filtroEquipos'>
    <ul class="nav nav-tabs">
        <li class="active" id='tab1' ><a href="#11" data-toggle="tab"><label for="">En almacen</label></a></li>
        <li class="" id='tab2' ><a href="#22" data-toggle="tab"><label for="">Cotizado en sitio</label></a></li>
        <li class="" id='tab3' ><a href="#33" data-toggle="tab"><label for="">Servicios cancelados</label></a></li>
    </ul>
