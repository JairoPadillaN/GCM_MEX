...
$(document).ready(function() {
   ...
   // alert ("hola");
        $("#filtroUtilidades").load('{{url('reporteUtilidadesAbajo')}}' + '?' + $(this).closest('form').serialize());
    ...
    <div class="col-md-12">
        <div class="panel panel-default" style="margin-top:-45px">
            ...
            <div class="panel-body">
                <div class="row">
                 <form method = 'post' action="{{route('reporteUtilidadesAbajo')}}"> <!---->
    ...
    $("#getData").on('click', () => {
        ...
        $.ajax({
            ...
            success: function( response ) {
                ...
                link.download = "reporteUtilidades.xlsx";
                link.click();
