...
<script>
    $("#marcas").change(function() {
        ...
        $("#partes").load('{{url('comboPartes')}}' + '?r=' + Date.now() + '&idMarcaRefa='  + this.options[this.selectedIndex].value) ;
    });
    ...
    $("#partes").change(function() {
        ...
        $("#precioVenta").load('{{url('precioParte')}}' + '?r=' + Date.now() + '&idPartesVenta='  + this.options[this.selectedIndex].value + '&tipoMoneda=' + tipoMoneda + '&cambioDolar=' + cambioDolar,function() {
                setTimeout(() => {
