    @if ($cuantosrfq == 0)
        ...
        <div class="alert alert-warning" role="alert" align="center">
            <label for="">Sin RFQs</label>
        </div>
    @else
        <table id="activos" class="display nowrap" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th class="no-mostrar" style="background-color: #C5EBFB">Vendedor</th>
                ...
                <tr class="filters">
                    ...
                    <th class="no-mostrar">Vendedor</th>
                        ...
                        <td>
                            ...
                            @if (Session::get('sesiontipo') == 'Compras')
                                <form action='' method='POST' enctype='application/x-www-form-urlencoded'>
                                    ...
                                    <input type="hidden" value="orden" name="nombreTab">
