...
<div class="col-xs-12">
    <div class="panel panel-default" style="margin-top:-55px">
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive" id="tablaConCambios">
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    @if($oc->fechaEntregaProveedor > "0000-00-00")
                                        ...
                                        ?>
                                        <br>
                                        <button value="{{$oc->idOrden}}" class="modificarFechaEntrega" style="background-color: Transparent;background-repeat:no-repeat;border: none;cursor:pointer;overflow: hidden;color:blue">
                            ...
                            <td>{{$oc->monedaComplementoPago}} ${{$oc->montoComplementoPago}}</td>                            
                            <td><center>{{$oc->estatus}}</td></center>
                            <td>{{$oc->notasCambioFechaEntregaProveedor}}</td>
                            
                            <td style="text-align:right;">{{$oc->moneda}} $<?php echo number_format ($oc->total,2)?></td>
                        </tr>
                        @endforeach                        
                        <tr>
                            <td colspan="6" style="text-align: right;">Importe</td>
                            <td colspan="" style="text-align: right;">{{$sumaTotalImpuestos->moneda}} ${{$sumaTotalImpuestos->importe}}</td>
                        </tr>
                        <tr>
                            <td colspan="6" style="text-align: right;">ISR</td>
...
<script>
    ...
    $(".modificarFechaEntrega").click(function (e) {
        var idOrden = $(this).val();
        var tipoReporte= '1';        
        $('#cargarModalFechaP').load('{{url('modificarFechaEntregaProveedor')}}' + '?idOrden='+idOrden + '&tipoReporte=' + tipoReporte);
        e.preventDefault(); 
    });
