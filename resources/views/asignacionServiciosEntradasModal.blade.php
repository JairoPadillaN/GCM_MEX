...
<script>
    ...
    $(document).ready(function(){
        // $("#idOrden").select2({dropdownParent: $('#modalParaAsignar'),width:'100%'});
        // $("#idProductoEntrada").select2({dropdownParent: $('#modalParaAsignar'),width:'100%'});
        $("#idFactura").select2({dropdownParent: $('#modalParaAsignar'),width:'100%'});
        
        crearSelectOC()
        crearSelectProductos('<?php echo $idOrden?>')
        $("#cantidadEnAlmacen,#cantidadAservicio").val('<?php echo $cantidadEnAlmacen?>');
    });
    ...
    //     }
    //     else if(document.querySelector("#tipoAsignacion_oc").checked && document.querySelector("#oc_destino").value == ''){
    ...
    function crearSelectProductos(idOrden){
        ...
        .done(function(data){
            ...
            $("#idProductoEntrada").val('<?php echo $idProductoEntrada?>');
            obtenerDatosProducto()
        });
    ...
    function cargarTablaProductosAsignados(datosConsulta, divParaCargarTabla){
        ...
        columna_5.innerHTML = "Servicio asignado";
        ...
        datosConsulta.forEach(datos => {
            ...
            $td_5.textContent = datos.idServicios;
