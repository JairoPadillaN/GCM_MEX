...
<div class="col-xs-12">
    <div class="panel panel-default" style="margin-top:-55px">
        <div class="panel-heading">
            <h1>Cotización de servicios<small> *Campos obligatorios</small></h1>
        </div>
...
<script>
    $(document).ready(function(){
        var tablita = $("#list").anexGrid({
            ...
            url: 'anexgridVersionesServiciosCotizacion',
            paginable: true,
            filtrable: true,
        ...
        var tablitaCanceladas = $("#listCanceladas").anexGrid({
            ...
            url: 'anexgridVersionesServiciosCanceladas',
            paginable: true,
            filtrable: true,
            limite: [5, 10, 20, 50, 100],
            columna: 'created_at',
...
<script type="text/javascript">
    $("#agregarCotizacion").click(function(e) {
        ...
        $("#altaVersion").load('{{url('altaCotizacionServicios')}}' + '?' + $(this).closest('form').serialize());
        }
    });
    ...
    $("#filtrar").click(function() {
        $("#altaVersion").empty();
        $("#reporteVersiones").empty();
        $("#reporteVersiones").load('{{url('reporteVersionesServiciosCotizacion')}}' + '?' + $(this).closest('form').serialize());
    });
