...
$(document).ready(function() {
   ...
   // alert ("hola");
        $("#filtroGastos").load('{{url('reporteGeneralGastosAbajo')}}' + '?' + $(this).closest('form').serialize());
    ...
    <div class="col-md-12">
        <div class="panel panel-default" style="margin-top:-45px">
            <div class="panel-heading">
                <h1 class="">Reporte General de Gastos</h1>
            </div><br>
            <div class="panel-body">
                <div class="row">
                 <form method = 'post' action="{{route('reporteGeneralGastosAbajo')}}"> <!---->
