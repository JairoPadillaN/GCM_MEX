    ...
    @csrf
        <div class="form-group col-md-6">                        
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select name='semanasEntrega' id='semanasEntrega' class="form-control" onchange=calcularPorcentaje()>
            ...
            <div class="form-group row" id="divSinDescuento">
                ...
                <div class="col-sm-6" style="">
                    <button type="button" class="btn btn-success btn-sm form-control rounded-0 agregarReparacion" onclick=calcularPorcentaje()>
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    <thead>
                        <tr style="background-color: #74B3E0;">
                            <th><font SIZE=2>Foto vista-superior</font></th>
                            <th><font SIZE=2>Foto vista-frontal</font></th>
                            <th><font SIZE=2>Foto Placa 1</font></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <font SIZE=2>
                                ...
                                <a target="_blank" href="{{asset ('archivos/'.$consulta->vistaSuperior)}}">
                                    <img src="{{asset ('archivos/'.$consulta->vistaSuperior)}}" height=80 width=80>
                                </a>
                                @endif
                            </font>
                            </td>
...
<script>
    ...
    $(".agregarReparacion").click(function() {
        ...
        if (semanas == "" || totalFin == 0 || monto == 0) {
            ...
            // $("#reporteReparaciones").load('{{url('reporteDeReparacionesAbajo')}}' + '?' + $(this).closest('form').serialize());            
...
<script>
    function obtenerTotal() {
        var totalRefacciones = $("#total").val();
        document.getElementById("montoEquipo").value = totalRefacciones;
    ...
    $("#tipoProducto").change(function() {
        ...
        if (tipoProducto == 'Nuevo' || tipoProducto == 'Refurbished y/o repair') {
            ...
            $("#idMarcaRefa, #idTipoRefacciones, #comboRef").val(''); 
        }
    ...
    $("#comboRef").change(function() {
        ...
        // document.getElementById('datos').innerHTML='<b>Parte: </b>'+comboParte+'<br><b>Tipo de parte: </b>'+tipoProducto+'<br><b>Marca: </b>'+ comboMarca+'<br><b>Tipo de refaccion: </b>'+comboTipoRef+'<br><b>Refacción:  </b>'+comboRef;        
