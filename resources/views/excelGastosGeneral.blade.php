    ...
    <tbody>
        @foreach( $data as $value )
            <tr>
                ...
                <td style='text-align:right;'> {{ $value['p'] }} </td>
                <td style='text-align:right;'> {{ $value['q'] }} </td>
                <td style='text-align:right;'> {{ $value['r'] }} </td>
        ...
        <tr>
                ...
                <td style='text-align:right; background-color:#ffdab9;'> {{$suma[0]->IVAMXN}} </td>
                <td style='text-align:right; background-color:#ffdab9;'> Total =  </td>
                <td style='text-align:right; background-color:#ffdab9;'> {{$suma[0]->ISRMXN}} </td>
                <td style='text-align:right; background-color:#ffdab9;'> Total = </td>
                <td style='text-align:right; background-color:#ffdab9;'> {{$suma[0]->TotalMXN}} </td>
            </tr>
    </tbody>
</table>
