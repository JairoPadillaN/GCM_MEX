...
<div class="col-md-12">
    <div style="margin-top:-45px">
        <div class="panel-heading">
            <h1 class="">Reporte servicios de publicidad</h1> <br>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                        <br>
                        <button type="button" class="btn  btn-default" name="agrega" id="filtrar">Aplicar filtro</button>
                        <button type="button" class="btn  btn-default" name="limpiar" id="limpia">Limpiar filtro</button>
                        <a href="{{asset('altaServPublicidad')}}"><button type="button" class="btn btn-primary">Agregar nuevo
                    registro</button></a>
                </div>
            </div>
        </div>
...
$("#filtrar").click(function(){
    $("#filtroPublicidad").load('{{url('reporteServPublicidadAbajo')}}' + '?' + $(this).closest('form').serialize());
});
